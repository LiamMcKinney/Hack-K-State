...
class Script {
    ...
    static void executeScript(String keypressOrder) {
        keypressOrder = keypressOrder.toLowerCase();
        ...
        for (int i = 0; i < keypressOrder.length(); i++) {
            switch (keypressOrder.charAt(i)) {
                ...
                case '%': robot.keyPress(KeyEvent.VK_DOWN); robot.keyRelease(KeyEvent.VK_DOWN); break;
                case '$': robot.keyPress(KeyEvent.VK_UP); robot.keyRelease(KeyEvent.VK_UP); break;
